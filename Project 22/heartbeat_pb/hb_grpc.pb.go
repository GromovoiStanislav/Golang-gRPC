...
const (
	HeartBeatService_UserHeartBeat_FullMethodName           = "/hb_proto.HeartBeatService/UserHeartBeat"
	HeartBeatService_LiveHeartBeat_FullMethodName           = "/hb_proto.HeartBeatService/LiveHeartBeat"
	HeartBeatService_HeartBeatHistory_FullMethodName        = "/hb_proto.HeartBeatService/HeartBeatHistory"
	HeartBeatService_NormalAbnormalHeartBeat_FullMethodName = "/hb_proto.HeartBeatService/NormalAbnormalHeartBeat"
)
...
func (c *heartBeatServiceClient) UserHeartBeat(ctx context.Context, in *HeartBeatRequest, opts ...grpc.CallOption) (*HeartBeatResponse, error) {
	...
	err := c.cc.Invoke(ctx, HeartBeatService_UserHeartBeat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *heartBeatServiceClient) LiveHeartBeat(ctx context.Context, opts ...grpc.CallOption) (HeartBeatService_LiveHeartBeatClient, error) {
	stream, err := c.cc.NewStream(ctx, &HeartBeatService_ServiceDesc.Streams[0], HeartBeatService_LiveHeartBeat_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *heartBeatServiceClient) HeartBeatHistory(ctx context.Context, in *HeartBeatHistoryRequest, opts ...grpc.CallOption) (HeartBeatService_HeartBeatHistoryClient, error) {
	stream, err := c.cc.NewStream(ctx, &HeartBeatService_ServiceDesc.Streams[1], HeartBeatService_HeartBeatHistory_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *heartBeatServiceClient) NormalAbnormalHeartBeat(ctx context.Context, opts ...grpc.CallOption) (HeartBeatService_NormalAbnormalHeartBeatClient, error) {
	stream, err := c.cc.NewStream(ctx, &HeartBeatService_ServiceDesc.Streams[2], HeartBeatService_NormalAbnormalHeartBeat_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _HeartBeatService_UserHeartBeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HeartBeatService_UserHeartBeat_FullMethodName,
	}
