...
const (
	...
	UserService_AddUserVerbose_FullMethodName    = "/user.UserService/AddUserVerbose"
	UserService_AddUsers_FullMethodName          = "/user.UserService/AddUsers"
	UserService_AddUserStreamBoth_FullMethodName = "/user.UserService/AddUserStreamBoth"
)
...
func (c *userServiceClient) AddUserVerbose(ctx context.Context, in *User, opts ...grpc.CallOption) (UserService_AddUserVerboseClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], UserService_AddUserVerbose_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) AddUsers(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], UserService_AddUsers_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) AddUserStreamBoth(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUserStreamBothClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], UserService_AddUserStreamBoth_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
