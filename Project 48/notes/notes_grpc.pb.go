...
const (
	Notes_Save_FullMethodName          = "/notes.Notes/Save"
	Notes_Load_FullMethodName          = "/notes.Notes/Load"
	Notes_SaveLargeNote_FullMethodName = "/notes.Notes/SaveLargeNote"
)
...
func (c *notesClient) Save(ctx context.Context, in *Note, opts ...grpc.CallOption) (*NoteSaveReply, error) {
	...
	err := c.cc.Invoke(ctx, Notes_Save_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) Load(ctx context.Context, in *NoteSearch, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := c.cc.Invoke(ctx, Notes_Load_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) SaveLargeNote(ctx context.Context, opts ...grpc.CallOption) (Notes_SaveLargeNoteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Notes_ServiceDesc.Streams[0], Notes_SaveLargeNote_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
