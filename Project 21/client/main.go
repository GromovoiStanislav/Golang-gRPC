...
func main() {
	...
	// runCreateMovie(client, "24325645", "Spiderman Spiderverse", "Stan", "Lee")
	// runUpdateMovie(client, "55661835", "24325645", "Spiderman Spiderverse","Peter", "Parker")
	// runDeleteMovie(client, "55661835")
}
